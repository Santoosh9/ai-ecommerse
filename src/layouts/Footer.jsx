            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-2">
                <Link to="/" className="inline-block mb-6">
                  <h2 className="text-3xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                    E-Shop
                  </h2>
                </Link>
                <p className="text-gray-300 mb-6 max-w-md">
                  Your premier destination for online shopping. We offer quality products with exceptional customer service and a seamless shopping experience.
                </p>
